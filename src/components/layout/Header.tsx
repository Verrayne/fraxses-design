  ...
  return (
    <header className="sticky top-0 z-30 border-b border-border bg-elevated">
      <div className="flex h-16 w-full items-center gap-4 px-5">
        <a href="/" className="flex min-w-0 flex-1 items-center gap-3 font-semibold">
        ...
        <div className="hidden w-full max-w-xl items-center gap-2 rounded-md border border-border bg-elevated px-3 py-2 text-sm text-subtle md:flex">
          <Search size={16} />
        ...
        <div className="hidden flex-1 items-center justify-end gap-2 text-sm text-subtle sm:flex">
          <SunMoon size={16} />
          <ThemeSwitcher />
        </div>
      </div>
