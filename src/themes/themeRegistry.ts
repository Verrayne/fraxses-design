...
export const themes: ThemeDefinition[] = [
  ...
  { id: "midnight", name: "Midnight", description: "The dark Fraxses theme.", status: "Available", intent: "Dark operational theme mapped into the shared semantic contract.", palettes: [], tokens: midnightTokens, accessibilityStatus: "Preserved from the existing dark theme and mapped to the shared token contract." },
  { id: "ocean", name: "Ocean", description: "A blue-led light theme.", status: "In progress", intent: "Temporary blue-led implementation while final Ocean values are pending.", palettes: [], tokens: oceanTokens, accessibilityStatus: "Needs source verification: final Ocean palette and contrast review are pending." },
];
