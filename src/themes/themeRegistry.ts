...
function buildForestTokens(): SemanticTokens {
  ...
  return {
    ...
    "badge-success-foreground": secondary[200], "badge-error": error[700], "badge-error-foreground": error[300],
...
function buildOryxTokens(): SemanticTokens {
  ...
  return {
    ...
    "badge-success-foreground": success[700], "badge-error": error[600], "badge-error-foreground": "#FFFFFF",
